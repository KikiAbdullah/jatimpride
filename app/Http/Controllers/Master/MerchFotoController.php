...
class MerchFotoController extends Controller
{
    public function __construct(MerchFoto $model)
    {
        $this->title            = 'Merch Foto';
        $this->subtitle         = 'Merch Foto List';
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($request->hasFile('foto')) {
                $filename = $this->saveFoto($request->foto, 'merch');
                $model->foto = $filename;
                $model->save();
            }
