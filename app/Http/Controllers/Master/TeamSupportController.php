...
class TeamSupportController extends Controller
{
    public function __construct(TeamSupport $model)
    {
        $this->title            = 'Team Support';
        $this->subtitle         = 'Team Support List';
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($request->hasFile('foto')) {
                $filename = $this->saveFoto($request->foto, 'team');
                $model->foto = $filename;
                $model->save();
            }
