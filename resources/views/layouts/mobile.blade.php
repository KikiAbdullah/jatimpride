    ...
    <div class="header-area" id="headerArea">
        <div class="container h-100 d-flex align-items-center justify-content-between d-flex rtl-flex-d-row-r">
            ...
            <div class="logo-wrapper"><a href="{{ route('mobile.index') }}"><img
                        src="{{ asset('mobile-asset/img/core-img/logo-small.png') }}" alt=""></a>
            </div>
    ...
    <div class="offcanvas offcanvas-start suha-offcanvas-wrap" tabindex="-1" id="suhaOffcanvas"
        ...
        <div class="offcanvas-body">
            ...
            <ul class="sidenav-nav ps-0">
                ...
                <li><a href="notifications.html"><i class="fa fa-bell lni-tada-effect"></i>Notifications<span
                            class="ms-1 badge badge-warning">3</span></a></li>
                <li class="suha-dropdown-menu"><a href="#"><i class="fa fa-store"></i>Shop Pages</a>
                    <ul>
                ...
                <li><a href="pages.html"><i class="fa fa-file-code"></i>All Pages</a></li>
                <li class="suha-dropdown-menu"><a href="wishlist-grid.html"><i class="fa fa-heart"></i>My
                        Wishlist</a>
                    <ul>
                ...
                <li><a href="settings.html"><i class="fa fa-sliders"></i>Settings</a></li>
                <li><a href="intro.html"><i class="fa fa-toggle-off"></i>Sign Out</a></li>
            </ul>
        </div>
    </div>
    <!-- PWA Install Alert -->
    <div class="toast pwa-install-alert shadow bg-white" role="alert" aria-live="assertive" aria-atomic="true"
        ...
        <div class="toast-body">
            <div class="content d-flex align-items-center mb-2"><img
                    src="{{ asset('mobile-asset/img/icons/icon-72x72.png') }}" alt="">
    ...
    <div class="footer-nav-area" id="footerNav">
        <div class="suha-footer-nav">
            <ul class="h-100 d-flex align-items-center justify-content-between ps-0 d-flex rtl-flex-d-row-r">
                <li class="{{ $title == 'Home' ? 'active' : '' }}"><a href="{{ route('mobile.index') }}">Home</a>
                </li>
                <li class="{{ $title == 'Cart' ? 'active' : '' }}"><a href="{{ route('mobile.cart') }}">Cart</a>
                </li>
                <li class="{{ $title == 'History' ? 'active' : '' }}"><a
                        href="{{ route('mobile.history') }}">History</a>
                </li>
            </ul>
        </div>
    </div>
